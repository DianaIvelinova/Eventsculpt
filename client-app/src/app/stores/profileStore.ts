        ...
        try {
            ...
            runInAction(() => {
                if (this.profile && this.profile.username !== store.userStore.user?.username && this.profile.username === username) {
                        if(following) { this.profile.followersCount++ } else { this.profile.followersCount-- }
                    this.profile.following = !this.profile.following;
                }
                if (this.profile && this.profile.username === store.userStore.user?.username) {
                    if(following) { this.profile.followingCount++ } else { this.profile.followingCount-- }
                }
                this.followings.forEach(profile => {
                    if (profile.username === username) {
                        if(profile.following) { profile.followersCount-- } else { profile.followersCount++ }
